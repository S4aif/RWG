    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseInjury", x => new { x.ExercisesId, x.InjuriesId });
                    table.ForeignKey(
                        name: "FK_ExerciseInjury_Exercises_ExercisesId",
                        column: x => x.ExercisesId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExerciseInjury_Injuries_InjuriesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExerciseInjury_InjuriesId",
                table: "ExerciseInjury",
                column: "InjuriesId");
